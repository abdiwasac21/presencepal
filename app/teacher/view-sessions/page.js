                  ...
                  >
                    <div>
                      <div className="text-xl font-extrabold text-blue-900 tracking-tight">
                        {course.courseName || <span className="italic text-gray-400">Unnamed Course</span>}
                      </div>
                      <div className="text-xs text-blue-700 mt-1">
                        Code: <span className="font-mono">{course.courseCode || "N/A"}</span>
                      </div>
                      ...
                      {course.sessions && course.sessions.length > 0 ? (
                        <div className="space-y-6">
                          {course.sessions.map((session) => (
                            <div key={session.sessionId} className="border rounded-xl mb-4 shadow hover:shadow-lg transition">
                              <button
                              ...
                              {openSessions[session.sessionId] && (
                                <div className="p-4 bg-white rounded-b-xl border-t">
                                  ...
                                  <div>
                                    <div className="font-semibold text-gray-700 mb-2 flex items-center">
                                      <span className="mr-2 text-red-600">❌</span> Missed Students
                                    ...
                                    {session.notAttendedStudents?.length === 0 ? (
                                      <div className="text-gray-400 italic text-sm ml-6">No missed students.</div>
                                    ) : (
                                      <ul className="list-none ml-0 mt-2">
                        ...
                        <div className="text-gray-400 italic">No sessions for this course.</div>
                      )}
                    </div>
                  )}
                </div>
