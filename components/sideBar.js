...
const Sidebar = () => {
    ...
    return (
        <>
            ...
            <button
                className="fixed top-4 left-4 z-50 md:hidden bg-gray-800 text-white p-2 rounded-md shadow"
            ...
            <div
                className={`
                    fixed top-0 left-0 h-full w-64 bg-gray-800 text-white flex flex-col p-4 z-50
            ...
            >
                ...
                <nav className="flex flex-col gap-4">
                    <Link href="/admin/dashboard" className="flex items-center gap-2 p-2 rounded-md hover:bg-gray-700">
                    ...
                    <Link href="/admin/class" className="flex items-center gap-2 p-2 rounded-md hover:bg-gray-700">
                        <Settings className="w-5 h-5" /> Class
                    </Link>
                    <button
                        onClick={handleLogout}
                        className="flex items-center gap-2 p-2 mt-auto text-red-400 hover:bg-gray-700"
                    >
